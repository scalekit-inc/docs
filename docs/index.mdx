...
Scalekit lets you add essential enterprise features such as Single sign-on (SSO) and SCIM provisioning to your app without custom coding or complex configurations. It integrates with all IDPs and Directories, giving you the flexibility to offer secure, friction-free authentication to your customers
...
- **Auto provision with SCIM**: Sync with all customer directories without custom code, securely enable auto-provisioning, de-provisioning, and automated assignment of roles in real-time for your app 
