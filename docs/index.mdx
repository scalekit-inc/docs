...
- **Ship SSO in a day, no custom dev:** SAML and OIDC supported. Prebuilt integrations with IdPs like Okta, Entra ID, Google SSO, and more. Includes SP-initiated and IdP-initiated SSO flows.
