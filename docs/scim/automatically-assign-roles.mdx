...
description:
  'Implement automated role assignment in your application using directory group memberships. Learn
  how to synchronize user roles with directory groups for efficient access management.'
keywords:
  [
...
In this scenario, you will listen for the
<SimpleCode>organization.directory.user_updated</SimpleCode> event to determine a user's role from
