...
description:
  'Learn how to map and customize SCIM user attributes between directory providers and your
  application. Enable personalized user experiences through custom attribute mapping and
  synchronization.'
keywords:
  [
    'SCIM Attributes',
...
3. Go to the "SCIM Provisioning" tab
