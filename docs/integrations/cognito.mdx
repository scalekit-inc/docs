...
Generate an authorization URL with two additional parameters— <SimpleCode>identity_provider</SimpleCode> and
<SimpleCode>login_hint</SimpleCode> — to redirect users seamlessly:
