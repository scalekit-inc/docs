...
title: "Scalekit SAML Configuration | Set Up SSO with Any IdP"
description: "Learn how to configure SAML-based Single Sign-On (SSO) in Scalekit with any Identity Provider, including service provider setup, attribute mapping, and user management."
...
<img src="@site/docs/sso/assets/integrations/saml-custom-provider/1.png" alt="Attribute Mapping section in SSO Configuration Portal" />
