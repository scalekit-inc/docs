...
Choose Microsoft AD FS as your identity provider to begin the configuration in admin portal. Download the Metadata XML file. We will provide this later to AD FS Server going forward.
...
- Enter the Metadata URL from Admin Portal directly (if network access allows)
