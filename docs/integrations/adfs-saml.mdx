...
1. Choose Microsoft AD FS as your identity provider to begin the configuration. Download the Metadata XML file. We will provide this later to AD FS Server going forward.
