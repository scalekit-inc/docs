...
<CodeWithHeader title="Create a new organization with an external ID">
...
<CodeWithHeader title="Update an existing organization's external ID">
...
<CodeWithHeader title="Create a new organization with metadata">
...
<CodeWithHeader title="Update an existing organization's metadata">
