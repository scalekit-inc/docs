...
<LabeledCheckbox id="3.1"> **Test the Single Sign on flows:** </LabeledCheckbox> Ensure comprehensive testing of Single Sign on flows with the Identity Provider across various scenarios(see [IdP initiated SSO](sso/test-sso)) to confirm the SSO flows work as expected.
