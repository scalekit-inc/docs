---
title: 'Scalekit Custom User Attributes | Enhance SSO with Personalized Data'
description: 'Learn how to define and map custom user attributes in Scalekit, such as employee numbers, to enrich Single Sign-On (SSO) integrations and improve user management.'
keywords:
  [
    'Scalekit',
    'SSO',
