...
Since the login is initiated from the identity provider's portal, this flow is called IdP-initiated SSO. Attackers can steal these assertions and use them to gain unauthorized access.
