...
if (idp_initiated_sso && idp_initiated_sso === 'success') {
  ...
  const authorizationURL = scalekit.getAuthorizationUrl(redirectUri, {
    ...
    ...(relay_state && { state: relay_state }), // Oass relay state
  });
...
String idpInitiatedLogin = request.getParameter("idp_initiated_sso");
...
if (idpInitiatedLogin != null && idpInitiatedLogin.equals("success")) {
    // handle idp initiated login
