...
Enter the user details simulating an user signing into your application via SSO. You will see the JSON form of user details in the UI, indicating that your simulation was successful.
