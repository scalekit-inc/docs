...
Now you're ready to start integrating SSO into your app!

<figure>
  ![How Scalekit
  works](@site/docs/sso/assets/single-sign-on/quickstart/how-sso-works.png)
  <figcaption>
    App initiates authentication via Scalekit, which determines the customer's IdP, handles abstractions, and authenticates the user.
  </figcaption>

</figure>

Next, we'll cover how to use the SDK to authenticate users.
