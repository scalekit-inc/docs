...
Go to API Config tab, and register a redirect URL. Scalekit will use this URL to redirect users
after authentication with users' identity provider.

### b. Handle User Payload

Get ready to facilitate successful sign-in, Scalekit sends a unique code to your Redirect URL.
...
[Try the sample app](https://github.com/scalekit-inc/sso-express-example)
