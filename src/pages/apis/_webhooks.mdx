...
<Parameter
  attrKey="type"
  type="string"
  description="Type of event that occurred. Indicates the specific action or state change."
/>
...
<Parameter
  attrKey="occurred_at"
  type="string"
  description="Timestamp of when the event was generated, in ISO 8601 format."
/>
...
<Parameter
  attrKey="environment_id"
  type="string"
  description="Unique identifier of the environment where the event occurred."
/>
...
<Parameter
  attrKey="organization_id"
  type="string"
  description="Unique identifier of the organization associated with the event."
/>


<Parameter attrKey="object" type="string" description="Type of object the event is related to." />
...
<Parameter
  ...
  type="string"
  description="Timestamp of the most recent directory synchronization in ISO 8601 format."
/>
...
>
  ...
  <Parameter
    attrKey="settings"
    type="object"
    description="Configuration settings for the directory connection.">
    <details>
      <summary>Settings Attributes</summary>
      <ul className="ApiReference-Parameters">
        <Parameter
          attrKey="custom_attributes"
          type="null"
          description="Custom attribute mappings. Currently set to null."
        />

        <Parameter
          attrKey="role_assignment"
          type="object"
          description="Role assignment configuration. Currently an empty object."
        />
      </ul>
    </details>
...
<Parameter
  attrKey="updated_at"
  type="string"
  description="Timestamp of the most recent update to the directory connection in ISO 8601 format."
/>
    ...
    <div className='col col--6'>
          ...
          <JsonViewer src={{
            ...
            "spec_version": "1",
            "id": "evt_49180589181370731",
            "type": "scalekit.dir.sync.disable",
            "occurred_at": "2024-12-05T06:45:15.481614Z",
            "environment_id": "env_27758032200925221",
            "organization_id": "org_41857058932261385",
            "object": "Directory",
            "data": {
              "directory_type": "SCIM",
              "enabled": false,
              "id": "dir_41857070105887249",
              "last_sync_at": "2024-12-04T10:29:16.02316Z",
              "organization_id": "org_41857058932261385",
              "provider": "OKTA",
              "settings": {
              ...
              "status": "IN_PROGRESS",
              "updated_at": "2024-12-05T06:45:15.470706388Z"
            }
          }} />
...
<div className="row section">
    <div className="col col--6">
       ...
       <ul className="ApiReference-Parameters">
            ...
            <Parameter attrKey="preferred_username" type="string" description="Preferred username of the directory user." />
