...
<div className="row section">
    <div className="col col--6">
        ...
        <ul className="ApiReference-Parameters">
            <li className="ApiReference-Parameter header">Event Data</li>
            <Parameter attrKey="directory_type" type="string" description="Type of directory protocol used for synchronization." />
            <Parameter attrKey="enabled" type="boolean" description="Indicates whether the directory synchronization is currently enabled or disabled." />
            <Parameter attrKey="id" type="string" description="Unique identifier for the directory connection." />
            <Parameter attrKey="last_sync_at" type="string" description="Timestamp of the most recent directory synchronization." />
            <Parameter attrKey="organization_id" type="string" description="Unique identifier of the organization associated with this directory." />
            <Parameter attrKey="provider" type="string" description="Identity provider for the directory connection." />
            <Parameter attrKey="settings" type="object" description="Configuration settings for the directory connection.">
                <details>
                    <summary>Settings Attributes</summary>
                    <Parameter attrKey="custom_attributes" type="null" description="Custom attribute mappings. Currently set to null." />
                    <Parameter attrKey="role_assignment" type="object" description="Role assignment configuration. Currently an empty object." />
                </details>
            </Parameter>
            <Parameter attrKey="status" type="string" description="Current status of the directory synchronization process." />
            <Parameter attrKey="updated_at" type="string" description="Timestamp of the most recent update to the directory connection." />
        </ul>
    </div>
    <div className="col col--6">
